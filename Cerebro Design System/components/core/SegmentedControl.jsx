...
if (typeof document !== "undefined" && !document.getElementById("cb-seg-css")) { const t = document.createElement("style"); t.id = "cb-seg-css"; t.textContent = css; document.head.appendChild(t); }
export function SegmentedControl({ options = [], value, onChange, size = "sm", style, className = "" }) {
  return (
