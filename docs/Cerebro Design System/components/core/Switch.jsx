...
if (typeof document !== "undefined" && !document.getElementById("cb-switch-css")) { const t = document.createElement("style"); t.id = "cb-switch-css"; t.textContent = css; document.head.appendChild(t); }
export function Switch({ checked, onChange, label, disabled, style, className = "" }) {
  return (
    <label className={`cb-switch ${checked ? "cb-switch-on" : ""} ${disabled ? "cb-switch-disabled" : ""} ${className}`} style={style}>
