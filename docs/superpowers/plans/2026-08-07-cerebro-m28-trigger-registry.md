...
**Brief for the agent picking this up cold.** Written 2026-08-07. M28.0 is a
...
closed scope. R1/R2 are intentionally `subscription_global`; R3–R14 require one
...
The exact mode map is: measurable roots R1/R3/R6/R7/R10/R13; hybrid root R2;
discretionary roots R8/R9/R11; per-object discretionary R4
...
is closed · missing samples evaluate `not_ready` · R1/R2/R3/R6/R7/R10/R13 are
reproducible from specified persisted primitives/snapshots using the same
distinct-ID filters/windows/floors/thresholds as the design · R4/R5/R8/R9/R11/R12/R14 retain
