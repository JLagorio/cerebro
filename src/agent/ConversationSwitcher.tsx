  ...
  return (
    <span className="relative inline-flex min-w-0">
      <button
        ...
        className="inline-flex min-w-0 items-center gap-1 rounded-md border-0 bg-transparent px-1 py-0.5 text-[12px] text-[var(--n-600)] hover:bg-[var(--n-50)] hover:text-[var(--n-900)]"
      >
        ...
        <>
          ...
          <div className="cb-menu-in absolute left-0 top-6 z-50 w-[260px] rounded-[10px] border border-[var(--n-200)] bg-[var(--n-0)] p-1 shadow-[var(--shadow-lg)]">
            <button
              ...
              className="mb-1 flex w-full items-center gap-1.5 rounded-[7px] border-0 bg-transparent px-2 py-1 text-left text-[12.5px] text-[var(--n-700)] hover:bg-[var(--n-50)]"
            >
              <Icon name="plus" size={12} color="var(--n-500)" />
              New conversation
            </button>
            <div className="max-h-[280px] overflow-y-auto border-t border-[var(--n-100)] pt-1">
                ...
                >
                  {confirming === c.id ? (
                    ...
                    <input
                      ...
                      className="min-w-0 flex-1 rounded border border-[var(--cortex-400)] bg-[var(--n-0)] px-1 py-0.5 text-[12px] outline-none"
                    />
                  ) : (
                    <>
                      <button
                      ...
                      >
                        {c.title}
                        {c.messages.length > 0 && (
                          <span className="ml-1.5 text-[10.5px] text-[var(--n-400)]">
