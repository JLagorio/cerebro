...
const css = `
.cb-tag{display:inline-flex;align-items:center;gap:6px;height:22px;padding:0 8px;border-radius:var(--r-sm);border:1px solid var(--n-200);background:var(--n-50);font-size:var(--fs-xs);font-weight:500;color:var(--n-700);white-space:nowrap;max-width:100%}
