  ...
  return (
    <span className="relative inline-flex">
      <button
        ...
        className="inline-flex h-7 items-center gap-1.5 rounded-md border border-n-200 bg-n-0 px-2 text-[12px] text-n-600 hover:border-n-300"
      >
      ...
      {open && (
        <>
          ...
          />
          <FixedBelowAnchor>
            <div className="w-[260px] rounded-[10px] border border-n-200 bg-n-0 p-2 shadow-[var(--shadow-lg)]">
              <div className="px-0.5 pb-1.5 text-[11px] text-n-500">
                {remote === null
